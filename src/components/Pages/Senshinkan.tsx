      ...
      <Grid container alignItems="center" display="flex">
        ...
        >
          ...
          <Typography variant="body1" align="left" data-aos="fade">
            <Strong>Senshinkan (洗心館)</Strong>, whose name can be translated
            as "the place (館) where you purify (洗) your heart/mind (心)", is a
            dojo where we teach <Strong>Hakko Denshin Ryu Ju Jutsu</Strong>{" "}
          ...
          <Typography
            ...
            data-aos="fade"
          >
            The main difference with most of the other Ju Jutsu styles is the
            use of wrist locks and Gakun, 雅勲, pressure on kyusho (急処 or
            急所, vital points situated along the meridians). short period.
          </Typography>
          <Typography
            variant="body1"
            color="text.primary"
          ...
          <Typography
            ...
            data-aos="fade"
          >
            We hope this site will bring you some additional information about
            our art.
          </Typography>
        </Grid>
      </Grid>
