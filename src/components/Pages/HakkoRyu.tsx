...
const sections: Section[] = [
    ...
    children: (
      <>
        ...
        >
          ...
          <Strong>Hakkō-ryū Jūjutsu</Strong> (八光流柔術) is a school or 'style'
          of jujutsu descended from <Strong>Daito-ryu</Strong>, founded in{" "}
          <Strong>1941</Strong> by&nbsp;
  ...
  {
    sectionTitle: "Meaning of the Name",
    ...
    children: (
      <>
        ...
        >
          ...
          as&nbsp;
          <Strong>"The Style of the Eighth Light"</Strong> or specifically&nbsp;
          ...
          the&nbsp;
          <Strong>ultraviolet band</Strong> — a band of light that is invisible
          to humans but responsible for causing sunburn while at the beach.
        </Typography>
        ...
        >
          ...
          strength, yet powerful in execution — not unlike the ultraviolet rays
          of the sun.
        </Typography>
      </>
    ),
    ...
    children: (
      <>
        ...
        >
          ...
          <Strong>Yasuhiro Irie</Strong>, <Strong>Michael LaMonica</Strong>, and{" "}
          <Strong>Antonio Garcia</Strong> — all of them high-ranking
          practitioners of <Strong>Hakko Ryu</Strong>, the school from which it
          descends, which is in turn based in part on&nbsp;
        ...
        >
          ...
          <Strong>"Heart and Spirit (Soul) of Hakko Ryu"</Strong>. In Japan, it
          is known as&nbsp;
    ...
    children: (
      <>
        ...
        <Typography
          ...
          data-aos="fade"
        >
          In the <Strong>1990s</Strong>, a former Hakko-ryu Sihan and student of
          Yasuhiro Irie, <Strong>Roy Hobbs</Strong>, received the&nbsp;
          <Strong>Menkyo Kaiden</Strong> (full teaching license) degree in&nbsp;
          <Strong>Kokodo Jujutsu</Strong> and, with Irie's permission, created a
          new descendant of Hakko Ryu called&nbsp;
        ...
        >
          ...
          <Strong>Palumbo</Strong> in <Strong>Colorado</Strong>. This system is
          not affiliated with the other schools.
        </Typography>
      </>
    ),
  },
    ...
    children: (
      <>
        ...
        >
          ...
          &nbsp; and the <Strong>needs of our time</Strong>. He became the&nbsp;
        ...
        >
          ...
          <Strong>true efficiency is invisible to the eyes</Strong>, just as are
          the <Strong>ultra-violet rays</Strong> (eighth color on the spectrum
    ...
    children: (
      <>
        ...
        >
          ...
          founded a ju-jutsu style he named&nbsp;
        ...
        >
          ...
          and&nbsp;
          <Strong>harmony</Strong>. This is still the challenge that traditional
  ...
  },
  {
    ...
    children: (
      ...
      >
        ...
        &nbsp;or&nbsp;
        <Strong>"defense"</Strong> and <Strong>taiso</Strong> (体操) means&nbsp;
